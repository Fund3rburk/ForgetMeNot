...
namespace ForgetMeNot.Controllers
{
    ...
    public class EventController : Controller
    {
        ...
        public async Task<JsonResult> GetEvents()
        {
            ...
            _logger.LogDebug("the user id filter returned: " + userIdFilter);
            ...
            if (!String.IsNullOrEmpty(userIdFilter))
            {
                ...
                var filteredEvents = Json(userEvents);

                _logger.LogDebug("user events for for id <" + userIdFilter + "> are..... : " + filteredEvents.ToString());
